...
/**
 * The "P.U.M.M.A" wordmark with a hover hint revealing the full name and the
...
export function PummaWordmark({ className }: { className?: string }) {
  return (
    <span className={cn("group/brand relative inline-block", className)}>
      <span className="cursor-default">P.U.M.M.A</span>
      <span
        aria-hidden="true"
      ...
      >
        ...
        <span className="mt-1.5 block text-[11px] font-normal leading-snug text-muted">
          I wanted to use PUMMA as the name, and Claude couldn&rsquo;t come up
