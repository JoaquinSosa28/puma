...
import { projectTaskEditHref } from "@/lib/task-links";
...
export function KanbanBoard({ tasks, tags, projectId, lifeView }: Props) {
...
function KanbanColumnStatic({
  ...
  return (
    <div className="kanban-column flex min-h-0 flex-col rounded-xl border border-border bg-surface2 p-3">
...
function KanbanColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={cn(
        "kanban-column flex min-h-0 flex-col rounded-xl border p-3 transition-all duration-200 ease-out",
        isOver
    ...
    <div
      ...
      className={cn(
        ...
        overlay
          ...
          : "hover:border-faint2 hover:shadow-sm"
      )}
    >
      <div className="mb-2 flex items-start gap-1.5">
        ...
        {!overlay && (
          <Link
            href={projectTaskEditHref(task, projectId, lifeView)}
            title="Edit task"
