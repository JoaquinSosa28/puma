  ...
  return (
    <>
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <div
          className="grid min-h-0 flex-1 grid-cols-[minmax(280px,34%)_minmax(480px,1fr)] overflow-hidden rounded-[13px] border border-border bg-surface animate-puma-view"
          style={{ boxShadow: "2px 2px 0 var(--shadow)" }}
        >
          <div ref={listRef} className="min-h-0 overflow-y-auto border-r border-border2 p-4">
          ...
          <div className="min-h-0 overflow-hidden bg-surface2/20">
            {selectedTask ? (
              <TaskDetailPanel
                task={selectedTask}
                tags={tags}
