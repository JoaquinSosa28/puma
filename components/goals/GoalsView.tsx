...
export function GoalsView({
  ...
  return (
    <>
      ...
      />
      <div
        className="grid min-h-0 flex-1 grid-cols-[minmax(0,1fr)_minmax(280px,320px)] overflow-hidden rounded-[13px] border border-border bg-surface animate-puma-view"
        style={{ boxShadow: "2px 2px 0 var(--shadow)" }}
      >
        <div className="min-h-0 overflow-y-auto border-r border-border2 p-4">
          {dragReady ? (
            <DndContext
              sensors={sensors}
